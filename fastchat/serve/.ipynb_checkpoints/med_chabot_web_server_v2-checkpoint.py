...
def add_text(state, model_selector, text, request: gr.Request):
    ...
    if (len(state.conv.messages) - state.conv.offset) // 2 >= CONVERSATION_TURN_LIMIT:
        ...
        state.skip_next = True
        return (state, state.to_gradio_chatbot(), CONVERSATION_LIMIT_MSG) + (no_change_btn,) * 8
...
def bot_response(
    ...
    if state.skip_next:
        ...
        yield (state, state.to_gradio_chatbot()) + (no_change_btn,) * 8
        return
    ...
    if model_api_dict is None:
        ...
        if worker_addr == "":
            ...
            yield (state, state.to_gradio_chatbot()) + (disable_btn,) * 8
            return
    ...
    try:
        ...
        output = data["text"].strip()
        conv.update_last_message(output)
        yield (state, state.to_gradio_chatbot()) + (enable_btn,) * 8
...
def build_single_model_ui(models, add_promotion_links=False):
    ...
    <p style="text-align: center;">Links: <a href="https://www.hackster.io/contests/amd2023/hardware_applications/16954">Proposal</a> | <a href="https://www.hackster.io/contests/amd2023/hardware_applications/16954">Report</a> | <a href="https://www.hackster.io/contests/amd2023/hardware_applications/16954">GitHub</a><br /></p>
    """
    ...
    with gr.Group(elem_id="prompt_window"):
        ...
        with gr.Row(variant='panel') as button_row:
            symptom_btn = gr.Button(value="What symptom may I have ?")
            clinic_btn = gr.Button(value="🏥What clinic should I go ?")
        # suggestion buttons
        with gr.Row(variant='panel') as button_row:
