...
def build_single_model_ui(add_promotion_links=False):
...
"""
    ...
    with gr.Group(elem_id="share-region-named"):
        with gr.Row():
            chatbot_descrip = gr.Textbox(
                label="Chat with your medical assistance."
            )
    ...
    textbox.submit(  # This listener is triggered when the user presses the Enter key while the Textbox is focused.
        add_text,
