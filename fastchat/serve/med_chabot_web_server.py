...
def build_single_model_ui(models, add_promotion_links=False):
    ...
    # Register listeners
    btn_list = [symptom_btn, suggest_send_btn, clinic_btn, suggestion1_btn, suggestion2_btn, suggestion3_btn, suggestion4_btn, regenerate_btn, clear_btn]
