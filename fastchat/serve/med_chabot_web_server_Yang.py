...
## Links: [Proposal](https://www.hackster.io/contests/amd2023/hardware_applications/16954) | [Report](https://www.hackster.io/contests/amd2023/hardware_applications/16954) | [GitHub](https://www.hackster.io/contests/amd2023/hardware_applications/16954)
"""
    ...
    with gr.Group(elem_id="share-region-named"):
        with gr.Row(elem_id="model_selector_row"):
            # with gr.Column(scale=1):
                # text_model = gr.Markdown("Model", elem_id="text_model_select")
        ...
        with gr.Row():
            with gr.Accordion(
                ...
                model_description_md = """medalpaca-7b is a large language model specifically fine-tuned for medical domain tasks. It is based on LLaMA and contains 7 billion parameters."""
                gr.Markdown(model_description_md, elem_id="model_description_markdown")
